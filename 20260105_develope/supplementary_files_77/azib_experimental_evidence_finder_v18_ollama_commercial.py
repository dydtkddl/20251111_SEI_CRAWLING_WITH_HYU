# -*- coding: utf-8 -*-
"""
AZIB Experimental Evidence Finder v18.0 (Commercial-grade + Ollama-assisted + Hierarchical Headings)
===============================================================================================
...
v18 upgrades v17 with the biggest real-world pain point:
...
def preprocess_text(raw: str) -> str:
    """
    Remove code blocks and inline code, normalize invisibles.
    """
...
def remove_caption_blocks(lines: List[str]) -> List[str]:
    """
    Removes figure/table caption blocks to reduce pollution.
    """
    out: List[str] = []
    i, n = 0, len(lines)
    while i < n:
...
class AZIBAnalyzer:
    ...
    def analyze_file(self, md_path: Path, base_dir: Path) -> DocResult:
        ...
        lines = remove_caption_blocks(text.splitlines())
